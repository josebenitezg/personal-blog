...
export default async function Project(params: Params) {
  const { project, moreProjects } = await getData(params)
            ...
            <div>
              ...
              <section className="prose lg:prose-xl dark:text-white">
                  ...
                  <div className="max-w-2xl mx-auto">
                    <div
                      className="prose lg:prose-xl dark:text-white dark:prose-dark mx-aut"
                    />
                    <MarkdownToHtml content={project.content}/>
                </div>
              </section>
            </div>
          </div>
